...
export const en = {
  ...
  landing: {
    ...
    descWC: 'Spin for a nation and a World Cup — Brazil 2002, Spain 2010, Argentina 2022. Build your XI of legends, then survive the group and three one-off finals.',
  ...
  draft: {
    ...
    lockedDescWC: '11 legends, picked from across the World Cups. One month. One trophy. No second chances.',
  ...
  wc: {
    ...
    group: (letter: string) => `Group ${letter}`,
    groupMatchday: (md: number) => `Group Stage · Matchday ${md}`,
    roundLabel: (round: string) => ({ 'quarter-finals': 'Quarter-final', 'semi-finals': 'Semi-final', 'third-place': 'Third-place match', final: 'World Cup Final' }[round] ?? round),
    knockoutBracket: 'The Road to the Final',
    qf: 'QF',
    sf: 'SF',
    final: 'FINAL',
  ...
  wcResults: {
    yourFinish: 'YOUR WORLD CUP',
    stageLabel: (s: string) => ({ group: 'Group Stage', 'quarter-finals': 'Quarter-finals', 'semi-finals': 'Fourth Place', 'third-place': 'BRONZE MEDAL', final: 'Runners-up', champion: 'WORLD CHAMPIONS' }[s] ?? s),
    stageBlurb: (s: string) => ({
      group: 'Home after three games. The nation demands answers.',
      'quarter-finals': 'A quarter-final exit — so near, yet so far.',
      'semi-finals': 'Lost the semi and the bronze match. Fourth hurts the most.',
      'third-place': 'A bronze medal — a podium finish on football\'s biggest stage.',
      final: 'Runners-up. A whole nation watched the trophy slip away.',
      champion: 'CHAMPIONS OF THE WORLD! Eternal glory is yours.',
    }[s] ?? ''),
    yourMvp: 'YOUR GOLDEN BALL',
    topScorers: 'GOLDEN BOOT RACE',
    yourSquad: (f: string) => `YOUR SQUAD · ${f}`,
    analyzing: 'Generating AI Briefing…',
    getAnalysis: 'Get AI Tournament Analysis',
    runItBack: 'Chase the Next Cup',
    eliminatedBy: (name: string) => `Knocked out by ${name}`,
    champion: '🏆 Champions:',
    runnerUp: '🥈',
    thirdPlace: '🥉',
    stats: { goals: 'Goals', assists: 'Assists', rating: 'Rating' },
  ...
  mode: {
    ...
    wc: { label: 'World Cup',        tagline: '16 nations · one-off knockouts', description: 'Draft from historic World Cup squads — Brazil 2002, Spain 2010, Argentina 2022 and more. Survive the group stage, then win three single-match finals for eternal glory.' },
  },
  formations: {
  ...
  banner: {
    ...
    wcLabel: 'World Cup · XI of legends',
    formation: 'FORMATION',
...
export const es: typeof en = {
  ...
  landing: {
    ...
    descWC: 'Gira para obtener una selección y un Mundial — Brasil 2002, España 2010, Argentina 2022. Forma tu XI de leyendas, supera el grupo y gana tres finales a partido único.',
  ...
  draft: {
    ...
    lockedDescWC: '11 leyendas elegidas de todos los Mundiales. Un mes. Un trofeo. Sin segundas oportunidades.',
  ...
  wc: {
    ...
    group: (letter) => `Grupo ${letter}`,
    groupMatchday: (md) => `Fase de grupos · Jornada ${md}`,
    roundLabel: (round) => ({ 'quarter-finals': 'Cuartos de final', 'semi-finals': 'Semifinal', 'third-place': 'Tercer puesto', final: 'Final del Mundial' }[round] ?? round),
    knockoutBracket: 'El camino a la final',
    qf: 'CF',
    sf: 'SF',
    final: 'FINAL',
    thirdPlaceShort: '3ER PUESTO',
    tbd: 'POR DEF.',
    pens: (h, a) => `Pens ${h}-${a}`,
    pensLong: (h, a) => `pens ${h}-${a}`,
  },
  wcResults: {
    yourFinish: 'TU MUNDIAL',
    stageLabel: (s) => ({ group: 'Fase de grupos', 'quarter-finals': 'Cuartos de final', 'semi-finals': 'Cuarto puesto', 'third-place': 'MEDALLA DE BRONCE', final: 'Subcampeones', champion: 'CAMPEONES DEL MUNDO' }[s] ?? s),
    stageBlurb: (s) => ({
      group: 'A casa tras tres partidos. El país exige explicaciones.',
      'quarter-finals': 'Eliminados en cuartos — tan cerca y tan lejos.',
      'semi-finals': 'Perdimos la semifinal y el partido por el bronce. El cuarto puesto es el que más duele.',
      'third-place': 'Medalla de bronce — un podio en el mayor escenario del fútbol.',
      final: 'Subcampeones. Todo un país vio escaparse el trofeo.',
      champion: '¡CAMPEONES DEL MUNDO! La gloria eterna es vuestra.',
    }[s] ?? ''),
    yourMvp: 'TU BALÓN DE ORO',
    topScorers: 'CARRERA POR LA BOTA DE ORO',
    yourSquad: (f) => `TU EQUIPO · ${f}`,
    analyzing: 'Generando informe de IA…',
    getAnalysis: 'Obtener análisis del torneo',
    runItBack: 'A por el próximo Mundial',
    eliminatedBy: (name) => `Eliminado por ${name}`,
    champion: '🏆 Campeones:',
    runnerUp: '🥈',
    thirdPlace: '🥉',
  ...
  mode: {
    ...
    wc: { label: 'Mundial',          tagline: '16 selecciones · eliminatorias únicas', description: 'Elige entre plantillas históricas de los Mundiales — Brasil 2002, España 2010, Argentina 2022 y más. Supera el grupo y gana tres finales a partido único para la gloria eterna.' },
  },
  formations: {
  ...
  banner: {
    ...
    wcLabel: 'Mundial · XI de leyendas',
    formation: 'FORMACIÓN',
