...
export const en = {
  ...
  landing: {
    ...
    randomName: 'Roll a random team name',
    formation: 'Formation',
  ...
  press: {
    ...
    preparing: 'Setting up the press room…',
    preparingSub: 'Journalists are preparing their questions',
    customPlaceholder: 'Write your own answer…',
    writing: 'Writing the article…',
    writingSub: 'The journalist is weaving your words into the story',
    retry: 'Try Again',
    summaryLabel: 'POST-MATCH PRESS REPORT',
  },
  postSim: {
...
export const es: typeof en = {
  ...
  landing: {
    ...
    randomName: 'Nombre de equipo aleatorio',
    formation: 'Formación',
  ...
  press: {
    ...
    preparing: 'Preparando la sala de prensa…',
    preparingSub: 'Los periodistas preparan sus preguntas',
    customPlaceholder: 'Escribe tu propia respuesta…',
    writing: 'Escribiendo el artículo…',
    writingSub: 'El periodista entrelaza tus palabras con la crónica',
    retry: 'Reintentar',
    summaryLabel: 'CRÓNICA POST-PARTIDO',
  },
  postSim: {
