...
export default function AuthMenu() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-11 z-50 min-w-[200px] glass p-2 text-sm">
          <div className="px-3 py-2 border-b border-white/10 mb-1">
            <div className="font-display text-sm truncate">{session.user.name ?? t.auth.account}</div>
            {session.user.email && (
