...
const SPECS: Record<string, Spec> = {
  ...
  euro:            { shape: 'cup',   a: '#D8E4F5', b: '#1B3FA0' },
  'copa-america':  { shape: 'cup',   a: '#F2E2A8', b: '#0B7A3B' },
  'asian-cup':     { shape: 'cup',   a: '#FFE9A8', b: '#B8860B' },
  afcon:           { shape: 'cup',   a: '#A8E0C0', b: '#1E6B4F' },
  'gold-cup':      { shape: 'cup',   a: '#FFD9A8', b: '#8A1538' },
  ...
  'world-cup-golden-boot': { shape: 'boot', a: '#FFC93D', b: '#7A5400' },
  'world-cup-golden-ball': { shape: 'ball', a: '#FFDF6B', b: '#7A5400' },
  'ucl-mvp':               { shape: 'star', a: '#EAF2FF', b: '#1B3FA0' },
